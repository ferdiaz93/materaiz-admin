...
function createShadow(color: string) {
  ...
  return {
    ...
    tertiary: `0 8px 16px 0 ${alpha(palette('light').tertiary.main, 0.24)}`,
    purple: `0 8px 16px 0 ${alpha(palette('light').purple.main, 0.24)}`,
    neutral: `0 8px 16px 0 ${alpha(palette('light').neutral.main, 0.24)}`,
    //

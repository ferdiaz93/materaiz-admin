...
const LazyAddonsListPage = withLoadingSpinner(
  lazyWithReload(() => import('src/features/addons/AddonsListPage'))
);
...

      {
        ...
        children: [
          ...
          },
          {
            ...
            path: 'addons',
            children: [
              { element: <Navigate to="/dashboard/addons/list" replace />, index: true },
              { path: 'list', element: <LazyAddonsListPage /> },
            ],
          },
          {
